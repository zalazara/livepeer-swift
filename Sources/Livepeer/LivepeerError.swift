...
///
/// ``LivepeerError`` describes problems which occur through the lifecycle of making a request to the API, from constructing the underlying network request, through making the network request and handling the resulting response.
///
/// Most of the error values have associated failure reasons:
/// - ``LivepeerError/failedToConstructRequestURL(_:)``
/// - ``LivepeerError/failedToSerializeRequestParameters(_:)``
/// - ``LivepeerError/failedToConstructRequest(_:)``
/// - ``LivepeerError/failedToHandleResponse(_:)``
///
/// which provide more information about why the error occurred.
///
/// If a network error occurs when making an API request, ``LivepeerError/failedToMakeNetworkRequest(error:)`` has an associated [`Error`](https://developer.apple.com/documentation/swift/error) value which describes more information about why the network error occurred.
///
/// In exceptional circumstances there may be an internal error which occurs in the implementation of ``Livepeer`` or in the underlying system frameworks. Where this occurs, ``LivepeerError/internalError(error:)`` provides this information, with additional context if it is available.
///
/// ### Getting an error description
///
/// ``LivepeerError`` conforms to the [`LocalizedError`](https://developer.apple.com/documentation/foundation/localizederror) protocol. As such a readable description of the error is provided through the [`errorDescription`](https://developer.apple.com/documentation/foundation/localizederror/2946895-errordescription) property.
///
/// ## Topics
///
/// ### Errors
...
/// - ``LivepeerError/failedToSerializeRequestParameters(_:)``
/// - ``LivepeerError/failedToConstructRequest(_:)``
/// - ``LivepeerError/failedToMakeNetworkRequest(error:)``
/// - ``LivepeerError/failedToHandleResponse(_:)``
/// - ``LivepeerError/internalError(error:)``
///
/// ### Error failure information
/// - ``LivepeerError/RequestURLConstructionFailureReason``
/// - ``LivepeerError/ParameterSerializationFailureReason``
/// - ``LivepeerError/RequestConstructionFailureReason``
/// - ``LivepeerError/ResponseHandlingFailureReason``
///
/// ### Convenience properties
/// - ``LivepeerError/underlyingError``
public enum LivepeerError: Swift.Error {
    /// Failure reasons for ``LivepeerError/failedToConstructRequestURL(_:)`` errors
    ...
    /// Failure reasons for ``LivepeerError/failedToSerializeRequestParameters(_:)`` errors
    ...
    /// Failure reasons for ``LivepeerError/failedToConstructRequest(_:)`` errors
    ...
    /// Failure reasons for ``LivepeerError/failedToHandleResponse(_:)`` errors
...
extension LivepeerError: LocalizedError {
...
extension LivepeerError.RequestURLConstructionFailureReason {
...
extension LivepeerError.ParameterSerializationFailureReason {
    public var localizedDescription: String {
        switch self {
...
extension LivepeerError.RequestConstructionFailureReason {
    public var localizedDescription: String {
        switch self {
        case .missingRequiredRequestBody:
...
extension LivepeerError.ResponseHandlingFailureReason {
    public var localizedDescription: String {
        switch self {
        case .failedToDecodeResponse:
