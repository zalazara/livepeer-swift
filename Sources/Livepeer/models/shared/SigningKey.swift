...
extension Shared {
    ...
    public struct SigningKey {
        ...
        ///
        public init(publicKey: String, createdAt: Double? = nil, disabled: Bool? = nil, id: String? = nil, lastSeen: Double? = nil, name: String? = nil) {
...
extension Shared.SigningKey: Codable {
